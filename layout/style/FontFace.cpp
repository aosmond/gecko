...
already_AddRefed<FontFace> FontFace::Constructor(
  ...
  if (!setImpl) {
    aRv.ThrowInvalidStateError("FontFaceSet already destroyed");
    return nullptr;
  }
