...
class FontFaceImplBufferSource;
...
class FontFaceImpl {
  ...
  friend class FontFaceImplBufferSource;
  friend class Entry;
 ...
 public:
  ...
  FontFace* GetOwningFontFace() const { return mOwner; }
 ...
 private:
  ...
  void InitializeSource(UniquePtr<uint8_t[]>&& aSourceBuffer);
  ...
  UniquePtr<uint8_t[]> mSourceBuffer;
