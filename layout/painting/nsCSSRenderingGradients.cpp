...
// gradients expect.
static sRGBColor InterpolateColor(const sRGBColor& aC1, const sRGBColor& aC2, float aFrac) {
...
static ColorStop InterpolateColorStop(const ColorStop& aFirst,
                                      ...
                                      double aPosition, const sRGBColor& aDefault) {
...
void nsCSSGradientRenderer::Paint(gfxContext& aContext, const nsRect& aDest,
  ...
  // FIXME(aosmond): We should resolve premultiply alphas after color management
