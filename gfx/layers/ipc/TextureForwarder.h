...
class LayersIPCChannel : public LayersIPCActor,
 ...
 public:
  ...
  virtual nsCOMPtr<nsISerialEventTarget> GetThread() const = 0;
...
class TextureForwarder : public LayersIPCChannel {
 public:
  ...
  virtual already_AddRefed<TextureReadLock> CreateBlockingTextureReadLock() {
    return TextureClient::CreateBlockingReadLock(this);
  }

  virtual already_AddRefed<TextureReadLock> CreateNonBlockingTextureReadLock() {
    return TextureClient::CreateNonBlockingReadLock(this);
  }
};
