...
void AppendToString(std::stringstream& aStream, const sRGBColor& c, const char* pfx,
                    const char* sfx) {
  aStream << pfx;
...
void AppendToString(std::stringstream& aStream, const DeviceColor& c, const char* pfx,
                    const char* sfx) {
  aStream << pfx;
