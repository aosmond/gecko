...
class DebugGLColorData final : public DebugGLData {
 public:
  DebugGLColorData(void* layerRef, const DeviceColor& color, int width, int height)
...
void SenderHelper::SendColor(void* aLayerRef, const DeviceColor& aColor, int aWidth,
                             int aHeight) {
