...
Compositor::Compositor(widget::CompositorWidget* aWidget,
    ...
    : mDiagnosticTypes(DiagnosticTypes::NO_DIAGNOSTIC),
      ...
      ,
      mClearColor(DeviceColor(1.0, 1.0, 1.0, 1.0)),
      mDefaultClearColor(DeviceColor(1.0, 1.0, 1.0, 1.0))
#else
      ,
...
void Compositor::SlowDrawRect(const gfx::Rect& aRect, const gfx::DeviceColor& aColor,
                              const gfx::IntRect& aClipRect,
                              const gfx::Matrix4x4& aTransform,
                              int aStrokeWidth) {
...
void Compositor::FillRect(const gfx::Rect& aRect, const gfx::DeviceColor& aColor,
                          const gfx::IntRect& aClipRect,
                          const gfx::Matrix4x4& aTransform) {
  float opacity = 1.0f;
  EffectChain effects;
