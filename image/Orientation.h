...
struct Orientation {
  ...
  OrientedIntSize FromUnoriented(const UnorientedIntSize& aSize) const {
  ...
  UnorientedIntSize FromOriented(const OrientedIntSize& aSize) const {
    if (SwapsWidthAndHeight()) {
  ...
  OrientedIntRect FromUnoriented(const UnorientedIntRect& aRect) const {
    if (SwapsWidthAndHeight()) {
  ...
  UnorientedIntRect FromOriented(const OrientedIntRect& aRect) const {
    if (SwapsWidthAndHeight()) {
