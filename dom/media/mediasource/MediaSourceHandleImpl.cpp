...
void MediaSourceHandleImpl::Destroy() {
  ...
  class DestroyRunnable final : public WorkerThreadRunnable {
   ...
   public:
    DestroyRunnable(RefPtr<ThreadSafeWorkerRef>&& aWorkerRef,
        ...
        : WorkerThreadRunnable("MediaSourceHandleImpl::DestroyRunnable"),
    ...
    bool DispatchToWorker() {
      return WorkerThreadRunnable::Dispatch(mWorkerRef->Private());
    }
  };
