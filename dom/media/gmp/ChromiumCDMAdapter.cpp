...
static WindowsDllInterceptor sKernelBase32Intercept;
...
static void InitializeHooks() {
  ...
  sKernelBase32Intercept.Init("kernelbase.dll");
  sOriginalQueryDosDeviceWFnPtr.Set(sKernelBase32Intercept, "QueryDosDeviceW",
                                    &QueryDosDeviceWHook);
