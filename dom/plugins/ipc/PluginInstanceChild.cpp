...
void PluginInstanceChild::PaintRectWithAlphaExtraction(const nsIntRect& aRect,
  ...
  PaintRectToSurface(rect, aSurface, DeviceColor(1.f, 1.f, 1.f));
  {
  ...
  // background
  PaintRectToSurface(rect, aSurface, DeviceColor(0.f, 0.f, 0.f));
  ...
  PaintRectToSurface(rect, whiteImage, DeviceColor(1.f, 1.f, 1.f));
  ...
  PaintRectToSurface(rect, blackImage, DeviceColor(0.f, 0.f, 0.f));
#endif
