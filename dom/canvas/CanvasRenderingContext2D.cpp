...
void CanvasRenderingContext2D::ArcTo(double aX1, double aY1, double aX2,
  ...
  if (IsNanOrInfinity(p1) || IsNanOrInfinity(p2) || IsNanOrInfinity(aRadius)) {
    return;
  }
...
void CanvasPath::MoveTo(double aX, double aY) {
  ...
  if (CanvasRenderingContext2D::IsNanOrInfinity(pos) ||
      mPathBuilder->CurrentPoint() == pos) {
    return;
  }
...
void CanvasPath::QuadraticCurveTo(double aCpx, double aCpy, double aX,
  ...
  if (CanvasRenderingContext2D::IsNanOrInfinity(cp1) ||
      CanvasRenderingContext2D::IsNanOrInfinity(cp2) || cp1 == cp2) {
    return;
  }
...
void CanvasPath::ArcTo(double aX1, double aY1, double aX2, double aY2,
  ...
  if (CanvasRenderingContext2D::IsNanOrInfinity(p1) ||
      CanvasRenderingContext2D::IsNanOrInfinity(p2) ||
      CanvasRenderingContext2D::IsNanOrInfinity(aRadius)) {
    return;
  }
...
void CanvasPath::LineTo(const gfx::Point& aPoint) {
  ...
  if (CanvasRenderingContext2D::IsNanOrInfinity(aPoint) ||
      mPathBuilder->CurrentPoint() == aPoint) {
    return;
  }
...
void CanvasPath::BezierTo(const gfx::Point& aCP1, const gfx::Point& aCP2,
  ...
  if (CanvasRenderingContext2D::IsNanOrInfinity(aCP1) ||
      CanvasRenderingContext2D::IsNanOrInfinity(aCP2) ||
      CanvasRenderingContext2D::IsNanOrInfinity(aCP3) ||
      (aCP1 == aCP2 && aCP1 == aCP3)) {
    return;
  }
