...
var snapshotFormatters = {
  ...
  async graphics(data) {
    ...
    if (AppConstants.NIGHTLY_BUILD || AppConstants.MOZ_DEV_EDITION) {
      ...
      let gpuNvidiaDeviceResetButton = $.new("button");
      ...
      gpuNvidiaDeviceResetButton.addEventListener("click", function() {
        windowUtils.triggerNvidiaDeviceReset();
      });
      ...
      document.l10n.setAttributes(
        gpuNvidiaDeviceResetButton,
        "gpu-nvidia-device-reset-button"
      );

      gpuResetItems.push(gpuInnocentDeviceResetButton);
      gpuResetItems.push(gpuGuiltyDeviceResetButton);
      gpuResetItems.push(gpuNvidiaDeviceResetButton);
    }
