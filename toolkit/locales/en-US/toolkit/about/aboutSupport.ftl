...
# NVIDIA device resets are specific to NVIDIA GPUs, and require the video memory
# to be cleared. This does not cause a full device reset in Firefox.
gpu-nvidia-device-reset-button = Simulate GL_PURGED_CONTEXT_RESET_NV
