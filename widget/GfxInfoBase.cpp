...
#define GFXINFO_FEATURE_STATUS(id, name) \
  if (aStatus.EqualsLiteral(name)) {     \
    return nsIGfxInfo::FEATURE_##id;     \
  }
#include "mozilla/widget/GfxInfoFeatureStatus.h"
...
#define GFXINFO_FEATURE_STATUS(id, name)            \
  case nsIGfxInfo::FEATURE_##id:                    \
    aStatusOut.Assign(NS_ConvertUTF8toUTF16(name)); \
    break;
#include "mozilla/widget/GfxInfoFeatureStatus.h"
#undef GFXINFO_FEATURE
    default:
