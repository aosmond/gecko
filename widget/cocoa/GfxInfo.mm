...
const nsTArray<GfxDriverInfo>& GfxInfo::GetGfxDriverInfo() {
  if (!sDriverInfo->Length()) {
    ...
    IMPLEMENT_MAC_DRIVER_BLOCKLIST(
        OperatingSystem::OSX10_11, DeviceFamily::IntelHD515, nsIGfxInfo::FEATURE_OPENGL_LAYERS,
        nsIGfxInfo::FEATURE_BLOCKED_DEVICE, "FEATURE_FAILURE_MAC_OSX10_11_INTELHD515_BROKEN");
    IMPLEMENT_MAC_DRIVER_BLOCKLIST(
        OperatingSystem::OSX10_11, DeviceFamily::IntelHD515, nsIGfxInfo::FEATURE_WEBRENDER,
        nsIGfxInfo::FEATURE_BLOCKED_DEVICE, "FEATURE_FAILURE_MAC_OSX10_11_INTELHD515_BROKEN");
    IMPLEMENT_MAC_DRIVER_BLOCKLIST(
