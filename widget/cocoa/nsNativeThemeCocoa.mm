...
bool nsNativeThemeCocoa::CreateWebRenderCommandsForWidget(
  ...
  switch (aAppearance) {
    ...
    case StyleAppearance::Tooltip:
      if (!VibrancyManager::SystemSupportsVibrancy()) {
        aBuilder.PushRect(bounds, bounds, true, wr::ToColorF(ToDeviceColor(kTooltipBackgroundColor)));
      }
      return true;
    ...
    case StyleAppearance::Textarea: {
      ...
      // White background
      aBuilder.PushRect(bounds, bounds, true, wr::ToColorF(ToDeviceColor(1.0, 1.0, 1.0, 1.0)));
    ...
    case StyleAppearance::Listbox: {
      // White background
      aBuilder.PushRect(bounds, bounds, true, wr::ToColorF(ToDeviceColorF(1.0, 1.0, 1.0, 1.0)));
